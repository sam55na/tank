        ...
        for (const friendUid of friends) {
            ...
            if (friend) {
                friendsData.push({
                    ...
                    isActive: false // يمكن تطويرها لاحقاً مع Socket.io
                });
            }
        }
...
app.listen(PORT, () => {
    ...
    console.log(`   POST /api/friends/reject`);
    console.log(`   POST /api/friends/remove`);
    console.log(`   GET  /api/user/bycode/:code`);
    console.log(`   GET  /api/friends/list/:uid`);
    console.log(`   GET  /api/friends/requests/:uid`);
